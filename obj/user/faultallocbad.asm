	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80024a:	e8 b1 0b 00 00       	call   800e00 <__udivdi3>
  ...
  800288:	e8 93 0c 00 00       	call   800f20 <__umoddi3>
  80028d:	83 c4 14             	add    $0x14,%esp
  800290:	0f be 80 db 10 80 00 	movsbl 0x8010db(%eax),%eax
  800297:	50                   	push   %eax
...
008002df <vprintfmt>:
{
  ...
  800418:	8b 14 85 00 13 80 00 	mov    0x801300(,%eax,4),%edx
  80041f:	85 d2                	test   %edx,%edx
  800421:	74 18                	je     80043b <vprintfmt+0x15c>
				printfmt(putch, putdat, "%s", p);
  800423:	52                   	push   %edx
  800424:	68 fc 10 80 00       	push   $0x8010fc
  800429:	53                   	push   %ebx
  80042a:	56                   	push   %esi
  ...
  80043b:	50                   	push   %eax
  80043c:	68 f3 10 80 00       	push   $0x8010f3
  800441:	53                   	push   %ebx
  800442:	56                   	push   %esi
  ...
  800463:	b8 ec 10 80 00       	mov    $0x8010ec,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b6f:	68 24 13 80 00       	push   $0x801324
  800b74:	6a 23                	push   $0x23
  800b76:	68 41 13 80 00       	push   $0x801341
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bf0:	68 24 13 80 00       	push   $0x801324
  800bf5:	6a 23                	push   $0x23
  800bf7:	68 41 13 80 00       	push   $0x801341
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c32:	68 24 13 80 00       	push   $0x801324
  800c37:	6a 23                	push   $0x23
  800c39:	68 41 13 80 00       	push   $0x801341
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c74:	68 24 13 80 00       	push   $0x801324
  800c79:	6a 23                	push   $0x23
  800c7b:	68 41 13 80 00       	push   $0x801341
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cb6:	68 24 13 80 00       	push   $0x801324
  800cbb:	6a 23                	push   $0x23
  800cbd:	68 41 13 80 00       	push   $0x801341
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cf8:	68 24 13 80 00       	push   $0x801324
  800cfd:	6a 23                	push   $0x23
  800cff:	68 41 13 80 00       	push   $0x801341
...
sys_ipc_recv(void *dstva)
{
  ...
  800d5c:	68 24 13 80 00       	push   $0x801324
  800d61:	6a 23                	push   $0x23
  800d63:	68 41 13 80 00       	push   $0x801341
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d8b:	68 00 f0 bf ee       	push   $0xeebff000
  800d90:	6a 00                	push   $0x0
  800d92:	e8 27 fe ff ff       	call   800bbe <sys_page_alloc>
		if (ret < 0) {
  800d97:	83 c4 10             	add    $0x10,%esp
  800d9a:	85 c0                	test   %eax,%eax
  800d9c:	78 28                	js     800dc6 <set_pgfault_handler+0x59>
		ret = sys_env_set_pgfault_upcall(0, _pgfault_upcall);
  800d9e:	83 ec 08             	sub    $0x8,%esp
  800da1:	68 d8 0d 80 00       	push   $0x800dd8
  800da6:	6a 00                	push   $0x0
  800da8:	e8 1a ff ff ff       	call   800cc7 <sys_env_set_pgfault_upcall>
		if (ret < 0) {
  800dad:	83 c4 10             	add    $0x10,%esp
  800db0:	85 c0                	test   %eax,%eax
  800db2:	79 c8                	jns    800d7c <set_pgfault_handler+0xf>
			panic("set_pgfault_handler: sys_env_set_pgfault_upcall failed: %e", ret);
  800db4:	50                   	push   %eax
  800db5:	68 80 13 80 00       	push   $0x801380
  800dba:	6a 26                	push   $0x26
  800dbc:	68 bb 13 80 00       	push   $0x8013bb
  800dc1:	e8 47 f3 ff ff       	call   80010d <_panic>
			panic("set_pgfault_handler: sys_page_alloc failed: %e", ret);
  800dc6:	50                   	push   %eax
  800dc7:	68 50 13 80 00       	push   $0x801350
  800dcc:	6a 22                	push   $0x22
  800dce:	68 bb 13 80 00       	push   $0x8013bb
  800dd3:	e8 35 f3 ff ff       	call   80010d <_panic>
...
_pgfault_upcall:
  ...
  800de0:	83 c4 04             	add    $0x4,%esp
	...
	subl $0x4, 0x30(%esp)
  800de3:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %eax
  800de8:	8b 44 24 30          	mov    0x30(%esp),%eax
	movl 0x28(%esp), %edx
  800dec:	8b 54 24 28          	mov    0x28(%esp),%edx
	movl %edx, (%eax)
...
00800e00 <__udivdi3>:
  ...
  800ea2:	ba 20 00 00 00       	mov    $0x20,%edx
  800ea7:	29 fa                	sub    %edi,%edx
  800ea9:	d3 e0                	shl    %cl,%eax
  800eab:	89 44 24 08          	mov    %eax,0x8(%esp)
  ...
  800ed7:	09 f3                	or     %esi,%ebx
  800ed9:	89 c6                	mov    %eax,%esi
  800edb:	89 f2                	mov    %esi,%edx
  800edd:	89 d8                	mov    %ebx,%eax
  800edf:	f7 74 24 08          	divl   0x8(%esp)
  800ee3:	89 d6                	mov    %edx,%esi
  800ee5:	89 c3                	mov    %eax,%ebx
  800ee7:	f7 64 24 0c          	mull   0xc(%esp)
  800eeb:	39 d6                	cmp    %edx,%esi
  800eed:	72 19                	jb     800f08 <__udivdi3+0x108>
  800eef:	89 f9                	mov    %edi,%ecx
  800ef1:	d3 e5                	shl    %cl,%ebp
  800ef3:	39 c5                	cmp    %eax,%ebp
  800ef5:	73 04                	jae    800efb <__udivdi3+0xfb>
  800ef7:	39 d6                	cmp    %edx,%esi
  800ef9:	74 0d                	je     800f08 <__udivdi3+0x108>
  800efb:	89 d8                	mov    %ebx,%eax
  800efd:	31 ff                	xor    %edi,%edi
  800eff:	e9 3c ff ff ff       	jmp    800e40 <__udivdi3+0x40>
  800f04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  800f08:	8d 43 ff             	lea    -0x1(%ebx),%eax
  800f0b:	31 ff                	xor    %edi,%edi
  800f0d:	e9 2e ff ff ff       	jmp    800e40 <__udivdi3+0x40>
...
00800f20 <__umoddi3>:
  ...
  800f33:	8b 7c 24 3c          	mov    0x3c(%esp),%edi
  800f37:	8b 6c 24 38          	mov    0x38(%esp),%ebp
  800f3b:	89 f0                	mov    %esi,%eax
  800f3d:	89 da                	mov    %ebx,%edx
  800f3f:	85 ff                	test   %edi,%edi
  800f41:	75 15                	jne    800f58 <__umoddi3+0x38>
  800f43:	39 dd                	cmp    %ebx,%ebp
  800f45:	76 39                	jbe    800f80 <__umoddi3+0x60>
  ...
  800f58:	39 df                	cmp    %ebx,%edi
  800f5a:	77 f1                	ja     800f4d <__umoddi3+0x2d>
  800f5c:	0f bd cf             	bsr    %edi,%ecx
  800f5f:	83 f1 1f             	xor    $0x1f,%ecx
  800f62:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  800f66:	75 40                	jne    800fa8 <__umoddi3+0x88>
  800f68:	39 df                	cmp    %ebx,%edi
  800f6a:	72 04                	jb     800f70 <__umoddi3+0x50>
  800f6c:	39 f5                	cmp    %esi,%ebp
  800f6e:	77 dd                	ja     800f4d <__umoddi3+0x2d>
  800f70:	89 da                	mov    %ebx,%edx
  800f72:	89 f0                	mov    %esi,%eax
  800f74:	29 e8                	sub    %ebp,%eax
  800f76:	19 fa                	sbb    %edi,%edx
  800f78:	eb d3                	jmp    800f4d <__umoddi3+0x2d>
  800f7a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  800f80:	89 e9                	mov    %ebp,%ecx
  800f82:	85 ed                	test   %ebp,%ebp
  800f84:	75 0b                	jne    800f91 <__umoddi3+0x71>
  ...
  800f9f:	eb ac                	jmp    800f4d <__umoddi3+0x2d>
  800fa1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  800fa8:	8b 44 24 04          	mov    0x4(%esp),%eax
  800fac:	ba 20 00 00 00       	mov    $0x20,%edx
  800fb1:	29 c2                	sub    %eax,%edx
  ...
  800fc7:	09 f9                	or     %edi,%ecx
  800fc9:	89 df                	mov    %ebx,%edi
  800fcb:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  800fcf:	89 c1                	mov    %eax,%ecx
  800fd1:	d3 e5                	shl    %cl,%ebp
  800fd3:	89 d1                	mov    %edx,%ecx
  800fd5:	d3 ef                	shr    %cl,%edi
  800fd7:	89 c1                	mov    %eax,%ecx
  800fd9:	89 f0                	mov    %esi,%eax
  800fdb:	d3 e3                	shl    %cl,%ebx
  800fdd:	89 d1                	mov    %edx,%ecx
  800fdf:	89 fa                	mov    %edi,%edx
  800fe1:	d3 e8                	shr    %cl,%eax
  800fe3:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  800fe8:	09 d8                	or     %ebx,%eax
  800fea:	f7 74 24 08          	divl   0x8(%esp)
  800fee:	89 d3                	mov    %edx,%ebx
  800ff0:	d3 e6                	shl    %cl,%esi
  800ff2:	f7 e5                	mul    %ebp
  800ff4:	89 c7                	mov    %eax,%edi
  800ff6:	89 d1                	mov    %edx,%ecx
  800ff8:	39 d3                	cmp    %edx,%ebx
  800ffa:	72 06                	jb     801002 <__umoddi3+0xe2>
  800ffc:	75 0e                	jne    80100c <__umoddi3+0xec>
  800ffe:	39 c6                	cmp    %eax,%esi
  801000:	73 0a                	jae    80100c <__umoddi3+0xec>
  801002:	29 e8                	sub    %ebp,%eax
  801004:	1b 54 24 08          	sbb    0x8(%esp),%edx
  801008:	89 d1                	mov    %edx,%ecx
  80100a:	89 c7                	mov    %eax,%edi
  80100c:	89 f5                	mov    %esi,%ebp
  80100e:	8b 74 24 04          	mov    0x4(%esp),%esi
  801012:	29 fd                	sub    %edi,%ebp
  801014:	19 cb                	sbb    %ecx,%ebx
  801016:	0f b6 4c 24 0c       	movzbl 0xc(%esp),%ecx
  80101b:	89 d8                	mov    %ebx,%eax
  80101d:	d3 e0                	shl    %cl,%eax
  80101f:	89 f1                	mov    %esi,%ecx
  801021:	d3 ed                	shr    %cl,%ebp
  801023:	d3 eb                	shr    %cl,%ebx
  801025:	09 e8                	or     %ebp,%eax

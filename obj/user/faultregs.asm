	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800776:	e8 b5 0b 00 00       	call   801330 <__udivdi3>
  ...
  8007b4:	e8 97 0c 00 00       	call   801450 <__umoddi3>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  8012be:	e8 27 fe ff ff       	call   8010ea <sys_page_alloc>
		if (ret < 0) {
  8012c3:	83 c4 10             	add    $0x10,%esp
  8012c6:	85 c0                	test   %eax,%eax
  8012c8:	78 28                	js     8012f2 <set_pgfault_handler+0x59>
		ret = sys_env_set_pgfault_upcall(0, _pgfault_upcall);
  8012ca:	83 ec 08             	sub    $0x8,%esp
  8012cd:	68 04 13 80 00       	push   $0x801304
  8012d2:	6a 00                	push   $0x0
  8012d4:	e8 1a ff ff ff       	call   8011f3 <sys_env_set_pgfault_upcall>
		if (ret < 0) {
  8012d9:	83 c4 10             	add    $0x10,%esp
  8012dc:	85 c0                	test   %eax,%eax
  8012de:	79 c8                	jns    8012a8 <set_pgfault_handler+0xf>
			panic("set_pgfault_handler: sys_env_set_pgfault_upcall failed: %e", ret);
  8012e0:	50                   	push   %eax
  8012e1:	68 60 19 80 00       	push   $0x801960
  8012e6:	6a 26                	push   $0x26
  8012e8:	68 9b 19 80 00       	push   $0x80199b
  8012ed:	e8 47 f3 ff ff       	call   800639 <_panic>
			panic("set_pgfault_handler: sys_page_alloc failed: %e", ret);
  8012f2:	50                   	push   %eax
  8012f3:	68 30 19 80 00       	push   $0x801930
  8012f8:	6a 22                	push   $0x22
  8012fa:	68 9b 19 80 00       	push   $0x80199b
  8012ff:	e8 35 f3 ff ff       	call   800639 <_panic>

00801304 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  801305:	a1 d0 20 80 00       	mov    0x8020d0,%eax
	call *%eax
  ...
  80130c:	83 c4 04             	add    $0x4,%esp
	...
	subl $0x4, 0x30(%esp)
  80130f:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %eax
  801314:	8b 44 24 30          	mov    0x30(%esp),%eax
	movl 0x28(%esp), %edx
  801318:	8b 54 24 28          	mov    0x28(%esp),%edx
	movl %edx, (%eax)
...
00801330 <__udivdi3>:
  ...
  801407:	09 f3                	or     %esi,%ebx
  801409:	89 c6                	mov    %eax,%esi
  80140b:	89 f2                	mov    %esi,%edx
  80140d:	89 d8                	mov    %ebx,%eax
  80140f:	f7 74 24 08          	divl   0x8(%esp)
  801413:	89 d6                	mov    %edx,%esi
  801415:	89 c3                	mov    %eax,%ebx
  801417:	f7 64 24 0c          	mull   0xc(%esp)
  80141b:	39 d6                	cmp    %edx,%esi
  80141d:	72 19                	jb     801438 <__udivdi3+0x108>
  80141f:	89 f9                	mov    %edi,%ecx
  801421:	d3 e5                	shl    %cl,%ebp
  801423:	39 c5                	cmp    %eax,%ebp
  801425:	73 04                	jae    80142b <__udivdi3+0xfb>
  801427:	39 d6                	cmp    %edx,%esi
  801429:	74 0d                	je     801438 <__udivdi3+0x108>
  80142b:	89 d8                	mov    %ebx,%eax
  80142d:	31 ff                	xor    %edi,%edi
  80142f:	e9 3c ff ff ff       	jmp    801370 <__udivdi3+0x40>
  801434:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  801438:	8d 43 ff             	lea    -0x1(%ebx),%eax
  80143b:	31 ff                	xor    %edi,%edi
  80143d:	e9 2e ff ff ff       	jmp    801370 <__udivdi3+0x40>
...
00801450 <__umoddi3>:
  ...
  80145b:	8b 74 24 30          	mov    0x30(%esp),%esi
  80145f:	8b 5c 24 34          	mov    0x34(%esp),%ebx
  801463:	8b 7c 24 3c          	mov    0x3c(%esp),%edi
  801467:	8b 6c 24 38          	mov    0x38(%esp),%ebp
  80146b:	89 f0                	mov    %esi,%eax
  80146d:	89 da                	mov    %ebx,%edx
  80146f:	85 ff                	test   %edi,%edi
  801471:	75 15                	jne    801488 <__umoddi3+0x38>
  801473:	39 dd                	cmp    %ebx,%ebp
  801475:	76 39                	jbe    8014b0 <__umoddi3+0x60>
  ...
  801488:	39 df                	cmp    %ebx,%edi
  80148a:	77 f1                	ja     80147d <__umoddi3+0x2d>
  80148c:	0f bd cf             	bsr    %edi,%ecx
  80148f:	83 f1 1f             	xor    $0x1f,%ecx
  801492:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  801496:	75 40                	jne    8014d8 <__umoddi3+0x88>
  801498:	39 df                	cmp    %ebx,%edi
  80149a:	72 04                	jb     8014a0 <__umoddi3+0x50>
  80149c:	39 f5                	cmp    %esi,%ebp
  80149e:	77 dd                	ja     80147d <__umoddi3+0x2d>
  8014a0:	89 da                	mov    %ebx,%edx
  8014a2:	89 f0                	mov    %esi,%eax
  8014a4:	29 e8                	sub    %ebp,%eax
  8014a6:	19 fa                	sbb    %edi,%edx
  8014a8:	eb d3                	jmp    80147d <__umoddi3+0x2d>
  8014aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  8014b0:	89 e9                	mov    %ebp,%ecx
  8014b2:	85 ed                	test   %ebp,%ebp
  8014b4:	75 0b                	jne    8014c1 <__umoddi3+0x71>
  ...
  8014c9:	f7 f1                	div    %ecx
  8014cb:	89 d0                	mov    %edx,%eax
  8014cd:	31 d2                	xor    %edx,%edx
  8014cf:	eb ac                	jmp    80147d <__umoddi3+0x2d>
  8014d1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  8014d8:	8b 44 24 04          	mov    0x4(%esp),%eax
  8014dc:	ba 20 00 00 00       	mov    $0x20,%edx
  8014e1:	29 c2                	sub    %eax,%edx
  8014e3:	89 c1                	mov    %eax,%ecx
  8014e5:	89 e8                	mov    %ebp,%eax
  8014e7:	d3 e7                	shl    %cl,%edi
  8014e9:	89 d1                	mov    %edx,%ecx
  8014eb:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8014ef:	d3 e8                	shr    %cl,%eax
  8014f1:	89 c1                	mov    %eax,%ecx
  8014f3:	8b 44 24 04          	mov    0x4(%esp),%eax
  8014f7:	09 f9                	or     %edi,%ecx
  8014f9:	89 df                	mov    %ebx,%edi
  8014fb:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  8014ff:	89 c1                	mov    %eax,%ecx
  801501:	d3 e5                	shl    %cl,%ebp
  801503:	89 d1                	mov    %edx,%ecx
  801505:	d3 ef                	shr    %cl,%edi
  801507:	89 c1                	mov    %eax,%ecx
  801509:	89 f0                	mov    %esi,%eax
  80150b:	d3 e3                	shl    %cl,%ebx
  80150d:	89 d1                	mov    %edx,%ecx
  80150f:	89 fa                	mov    %edi,%edx
  801511:	d3 e8                	shr    %cl,%eax
  801513:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  801518:	09 d8                	or     %ebx,%eax
  80151a:	f7 74 24 08          	divl   0x8(%esp)
  80151e:	89 d3                	mov    %edx,%ebx
  801520:	d3 e6                	shl    %cl,%esi
  801522:	f7 e5                	mul    %ebp
  801524:	89 c7                	mov    %eax,%edi
  801526:	89 d1                	mov    %edx,%ecx
  801528:	39 d3                	cmp    %edx,%ebx
  80152a:	72 06                	jb     801532 <__umoddi3+0xe2>
  80152c:	75 0e                	jne    80153c <__umoddi3+0xec>
  80152e:	39 c6                	cmp    %eax,%esi
  801530:	73 0a                	jae    80153c <__umoddi3+0xec>
  801532:	29 e8                	sub    %ebp,%eax
  801534:	1b 54 24 08          	sbb    0x8(%esp),%edx
  801538:	89 d1                	mov    %edx,%ecx
  80153a:	89 c7                	mov    %eax,%edi
  80153c:	89 f5                	mov    %esi,%ebp
  80153e:	8b 74 24 04          	mov    0x4(%esp),%esi
  801542:	29 fd                	sub    %edi,%ebp
  801544:	19 cb                	sbb    %ecx,%ebx
  801546:	0f b6 4c 24 0c       	movzbl 0xc(%esp),%ecx
  80154b:	89 d8                	mov    %ebx,%eax
  80154d:	d3 e0                	shl    %cl,%eax
  80154f:	89 f1                	mov    %esi,%ecx
  801551:	d3 ed                	shr    %cl,%ebp
  801553:	d3 eb                	shr    %cl,%ebx
  801555:	09 e8                	or     %ebp,%eax

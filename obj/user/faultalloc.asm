...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800da0:	68 00 f0 bf ee       	push   $0xeebff000
  800da5:	6a 00                	push   $0x0
  800da7:	e8 27 fe ff ff       	call   800bd3 <sys_page_alloc>
		if (ret < 0) {
  800dac:	83 c4 10             	add    $0x10,%esp
  800daf:	85 c0                	test   %eax,%eax
  800db1:	78 28                	js     800ddb <set_pgfault_handler+0x59>
		ret = sys_env_set_pgfault_upcall(0, _pgfault_upcall);
  800db3:	83 ec 08             	sub    $0x8,%esp
  800db6:	68 ed 0d 80 00       	push   $0x800ded
  800dbb:	6a 00                	push   $0x0
  800dbd:	e8 1a ff ff ff       	call   800cdc <sys_env_set_pgfault_upcall>
		if (ret < 0) {
  800dc2:	83 c4 10             	add    $0x10,%esp
  800dc5:	85 c0                	test   %eax,%eax
  800dc7:	79 c8                	jns    800d91 <set_pgfault_handler+0xf>
			panic("set_pgfault_handler: sys_env_set_pgfault_upcall failed: %e", ret);
  800dc9:	50                   	push   %eax
  800dca:	68 a0 13 80 00       	push   $0x8013a0
  800dcf:	6a 26                	push   $0x26
  800dd1:	68 db 13 80 00       	push   $0x8013db
  800dd6:	e8 47 f3 ff ff       	call   800122 <_panic>
			panic("set_pgfault_handler: sys_page_alloc failed: %e", ret);
  800ddb:	50                   	push   %eax
  800ddc:	68 70 13 80 00       	push   $0x801370
  800de1:	6a 22                	push   $0x22
  800de3:	68 db 13 80 00       	push   $0x8013db
  800de8:	e8 35 f3 ff ff       	call   800122 <_panic>
...
_pgfault_upcall:
  ...
  800df5:	83 c4 04             	add    $0x4,%esp
	...
	subl $0x4, 0x30(%esp)
  800df8:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %eax
  800dfd:	8b 44 24 30          	mov    0x30(%esp),%eax
	movl 0x28(%esp), %edx
  800e01:	8b 54 24 28          	mov    0x28(%esp),%edx
	movl %edx, (%eax)

	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001cf:	e8 fc 0b 00 00       	call   800dd0 <__udivdi3>
  ...
  80020d:	e8 de 0c 00 00       	call   800ef0 <__umoddi3>
...
sys_env_destroy(envid_t envid)
{
  ...
  800b00:	e8 7c 02 00 00       	call   800d81 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b81:	e8 fb 01 00 00       	call   800d81 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bc3:	e8 b9 01 00 00       	call   800d81 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c05:	e8 77 01 00 00       	call   800d81 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c47:	e8 35 01 00 00       	call   800d81 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c89:	e8 f3 00 00 00       	call   800d81 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800ced:	e8 8f 00 00 00       	call   800d81 <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d0e:	6a 07                	push   $0x7
  800d10:	68 00 f0 bf ee       	push   $0xeebff000
  800d15:	6a 00                	push   $0x0
  800d17:	e8 27 fe ff ff       	call   800b43 <sys_page_alloc>
		if (ret < 0) {
  800d1c:	83 c4 10             	add    $0x10,%esp
  800d1f:	85 c0                	test   %eax,%eax
  800d21:	78 28                	js     800d4b <set_pgfault_handler+0x59>
		ret = sys_env_set_pgfault_upcall(0, _pgfault_upcall);
  800d23:	83 ec 08             	sub    $0x8,%esp
  800d26:	68 5d 0d 80 00       	push   $0x800d5d
  800d2b:	6a 00                	push   $0x0
  800d2d:	e8 1a ff ff ff       	call   800c4c <sys_env_set_pgfault_upcall>
		if (ret < 0) {
  800d32:	83 c4 10             	add    $0x10,%esp
  800d35:	85 c0                	test   %eax,%eax
  800d37:	79 c8                	jns    800d01 <set_pgfault_handler+0xf>
			panic("set_pgfault_handler: sys_env_set_pgfault_upcall failed: %e", ret);
  800d39:	50                   	push   %eax
  800d3a:	68 e0 12 80 00       	push   $0x8012e0
  800d3f:	6a 26                	push   $0x26
  800d41:	68 1b 13 80 00       	push   $0x80131b
  800d46:	e8 36 00 00 00       	call   800d81 <_panic>
			panic("set_pgfault_handler: sys_page_alloc failed: %e", ret);
  800d4b:	50                   	push   %eax
  800d4c:	68 b0 12 80 00       	push   $0x8012b0
  800d51:	6a 22                	push   $0x22
  800d53:	68 1b 13 80 00       	push   $0x80131b
  800d58:	e8 24 00 00 00       	call   800d81 <_panic>
...
_pgfault_upcall:
  ...
  800d65:	83 c4 04             	add    $0x4,%esp
	...
	subl $0x4, 0x30(%esp)
  800d68:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %eax
  800d6d:	8b 44 24 30          	mov    0x30(%esp),%eax
	movl 0x28(%esp), %edx
  800d71:	8b 54 24 28          	mov    0x28(%esp),%edx
	movl %edx, (%eax)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d85:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  800d86:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800d89:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800d8f:	e8 71 fd ff ff       	call   800b05 <sys_getenvid>
  800d94:	83 ec 0c             	sub    $0xc,%esp
  800d97:	ff 75 0c             	push   0xc(%ebp)
  800d9a:	ff 75 08             	push   0x8(%ebp)
  800d9d:	56                   	push   %esi
  800d9e:	50                   	push   %eax
  800d9f:	68 2c 13 80 00       	push   $0x80132c
  800da4:	e8 c4 f3 ff ff       	call   80016d <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800da9:	83 c4 18             	add    $0x18,%esp
  800dac:	53                   	push   %ebx
  800dad:	ff 75 10             	push   0x10(%ebp)
  800db0:	e8 67 f3 ff ff       	call   80011c <vcprintf>
	cprintf("\n");
  800db5:	c7 04 24 3a 10 80 00 	movl   $0x80103a,(%esp)
  800dbc:	e8 ac f3 ff ff       	call   80016d <cprintf>
  800dc1:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800dc4:	cc                   	int3   
  800dc5:	eb fd                	jmp    800dc4 <_panic+0x43>
